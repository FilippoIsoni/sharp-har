...
**Emendamento v5.2 (cfr. `splits/CHANGELOG.md`):** la riga C4 non si esegue; le estensioni pre-registrate E1′ (2 run ≈ 4.6 h) + E2′ (1 run ≈ 2.5 h) ≈ 7.1 h — dello stesso ordine del budget liberato da C4 (proiezione di gate 6.87 h) e molto sotto l'inviluppo estensioni pre-v5.2 (E1+E2+E3: 15–35 h). Nessun'altra run si aggiunge alla tabella.
