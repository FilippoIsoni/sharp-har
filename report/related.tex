...
same-label samples as positives, and reports more robust representations than
cross-entropy --- but only parity on transfer, and objectives that sharpen
class separation can transfer worse~\cite{Kornblith-2021}.
