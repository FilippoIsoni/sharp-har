...
with a $10\times$ larger seed spread: no domain attribute is linearly readable
...
\secref{sec:processing_architecture}--\secref{sec:learning_framework} the
pipeline, signals, splits and learning framework, \secref{sec:results} the
results, and \secref{sec:conclusions} concludes.
