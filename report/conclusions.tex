...
encoder fails in the representation itself: no readout we tried, nor a full CE
fine-tune, recovers the gap --- its features carry less of what tells the
activities apart. The adversary
