...
held-out capture sets as the original work reports. Since C0 differs from
...
informative about the activity than CE's, and no head, linear or not, recovers
what they do not encode.
...
A GRL removes only what its discriminator reads --- and our probe is linear,
...
chains into one filament. The confusions are between
...
$0.243$; antenna averaging, plus label smoothing) while the GRL model is the
