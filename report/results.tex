...
difference against our model C1. C1 transfers best among them (macro-F1
$0.804$ against a $0.13$ majority baseline, seed-stable to
...
checkpoints and on the second rotation --- five encoders in total --- return the same
...
A GRL removes domain information its discriminator can read; here there is
...
$+0.007$ here, with an interval crossing zero). Beyond those, model selection is
